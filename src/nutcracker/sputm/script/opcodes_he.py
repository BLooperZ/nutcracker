...
OPCODES_he60 = realize(
    {
        **OPCODES_v6,
        ...
        0x9A: None,
        0x9C: makeop('o60_roomOps', SUBOP(SubOpsHE60, {
            SubOpsHE60.SO_ROOM_SAVEGAME_BY_NAME: (MSG_OP,),
        })),
        0x9D: makeop('o60_actorOps', SUBOP(SubOpsHE60, {
        ...
        0xEA: makeop('o60_redimArray', SUBOP(SubOpsHE60, {
            SubOpsHE60.SO_INT_ARRAY: (IMWORD,),
            SubOpsHE60.SO_BYTE_ARRAY: (IMWORD,),
        })),
...
OPCODES_he72: OpTable = realize(
    {
        **OPCODES_he71,
        ...
        0x51: makeop('o72_getHeap', IMBYTE),
        ...
        0x97: None,
        0x9C: makeop('o72_roomOps', SUBOP(SubOpsHE72)),
        0x9D: makeop('actorOps', SUBOP(SubOpsHE72)),
        0x9E: makeop('o72_verbOps', SUBOP(SubOpsHE72)),
        ...
        0xA4: makeop('o72_arrayOps', SUBOP(SubOpsHE72, {
            ...
            SubOpsHE72.SO_COMPLEX_ARRAY_MATH_OPERATION: (IMWORD, IMWORD, IMDWORD),
...
OPCODES_he90: OpTable = realize(
    {
        **OPCODES_he80,
        ...
        0x2D: makeop('o90_videoOps', SUBOP(SubOpsHE90)),
        0x2E: makeop('o90_getVideoData', SUBOP(SubOpsHE90)),
...
OPCODES_he100: OpTable = realize(
    {
        0x00: makeop('o100_actorOps', SUBOP(SubOpsHE100.Actor)),
        0x01: makeop('o6_add'),
        0x02: makeop('o6_faceActor'),
        0x03: makeop('o90_sortArray', SUBOP(SubOpsHE100.Array)),
        0x04: makeop('o100_arrayOps', SUBOP(SubOpsHE100.Array, {
        ...
        0x1F: makeop('o100_dimArray', SUBOP(SubOpsHE100.Array, {
            SubOpsHE100.Array.SO_BIT: (IMWORD,),
            SubOpsHE100.Array.SO_NIBBLE: (IMWORD,),
            SubOpsHE100.Array.SO_BYTE: (IMWORD,),
            SubOpsHE100.Array.SO_INT: (IMWORD,),
        ...
        0x26: makeop('o100_drawLine', SUBOP(SubOpsHE100.Common)),
        0x27: makeop('o100_drawObject', SUBOP(SubOpsHE100.Common)),
        0x28: makeop('o6_dup'),
        ...
        0x32: makeop('o100_setSpriteGroupInfo', SUBOP(SubOpsHE100.Common)),
        0x33: makeop('o6_gt'),
        0x34: makeop('o100_resourceRoutines', SUBOP(SubOpsHE100.Heap)),
        0x35: makeop('o6_if', OFFSET),
        0x36: makeop('o6_ifNot', OFFSET),
        0x37: makeop('o100_wizImageOps', SUBOP(SubOpsHE100.Image)),
        ...
        0x45: makeop('o6_mul'),
        0x46: makeop('o6_neq'),
        0x47: makeop('o100_dim2dim2Array', SUBOP(SubOpsHE100.Array, {
            SubOpsHE100.Array.SO_BIT: (IMWORD,),
            SubOpsHE100.Array.SO_NIBBLE: (IMWORD,),
            SubOpsHE100.Array.SO_BYTE: (IMWORD,),
            SubOpsHE100.Array.SO_INT: (IMWORD,),
        ...
        0x49: makeop('o100_redim2dimArray', SUBOP(SubOpsHE100.Array, {
            SubOpsHE100.Array.SO_BYTE: (IMWORD,),
            SubOpsHE100.Array.SO_INT: (IMWORD,),
            SubOpsHE100.Array.SO_DWORD: (IMWORD,),
        })),
        ...
        0x50: makeop('o100_paletteOps', SUBOP(SubOpsHE100.Common)),
        0x51: makeop('o70_pickupObject'),
        0x52: makeop('o100_polygonOps', SUBOP(SubOpsHE100.Common)),  # o71_polygonOps
        0x53: makeop('o6_pop'),
        0x54: makeop('o100_printDebug', SUBOP(SubOpsHE100.Common, {
            SubOpsHE100.Common.SO_TEXTSTRING: (MSG_OP,),
            SubOpsHE100.Common.SO_FORMATTED_STRING: (MSG_OP,),
        })),  # o6_printDebug
        0x55: makeop('o72_printWizImage'),
        0x56: makeop('o100_printLine', SUBOP(SubOpsHE100.Common, {
            SubOpsHE100.Common.SO_TEXTSTRING: (MSG_OP,),
            SubOpsHE100.Common.SO_FORMATTED_STRING: (MSG_OP,),
        })),  # o6_printLine
        0x57: makeop('o100_printSystem', SUBOP(SubOpsHE100.Common, {
            SubOpsHE100.Common.SO_TEXTSTRING: (MSG_OP,),
            SubOpsHE100.Common.SO_FORMATTED_STRING: (MSG_OP,),
        })),  # o6_printSystem
        0x58: makeop('o100_printText', SUBOP(SubOpsHE100.Common, {
            SubOpsHE100.Common.SO_TEXTSTRING: (MSG_OP,),
            SubOpsHE100.Common.SO_FORMATTED_STRING: (MSG_OP,),
        })),  # o6_printText
        # TODO: 0x59: makeop('o100_priorityStartScript', SUBOP(SubOpsHE100.Script)),
        0x5A: makeop('o100_priorityChainScript', SUBOP(SubOpsHE100.Script)),
        ...
        0x64: makeop('o100_redimArray', SUBOP(SubOpsHE100.Array, {
            SubOpsHE100.Array.SO_BYTE: (IMWORD,),
            SubOpsHE100.Array.SO_INT: (IMWORD,),
            SubOpsHE100.Array.SO_DWORD: (IMWORD,),
        })),
        ...
        0x68: makeop('o100_roomOps', SUBOP(SubOpsHE100.Room)),
        0x69: makeop('o100_printActor', SUBOP(SubOpsHE100.Common, {
            SubOpsHE100.Common.SO_TEXTSTRING: (MSG_OP,),
            SubOpsHE100.Common.SO_FORMATTED_STRING: (MSG_OP,),
        })),  # o6_printActor
        0x6A: makeop('o100_printEgo', SUBOP(SubOpsHE100.Common, {
            SubOpsHE100.Common.SO_TEXTSTRING: (MSG_OP,),
            SubOpsHE100.Common.SO_FORMATTED_STRING: (MSG_OP,),
        })),  # o6_printEgo
        ...
        0x87: makeop('o6_sub'),
        0x88: makeop('o100_systemOps', SUBOP(SubOpsHE100.System)),
        0x8A: makeop('o72_setTimer', SUBOP(SubOpsHE100.Common)),
        0x8B: makeop('o100_cursorCommand', SUBOP(SubOpsHE100.Cursor)),
        0x8C: makeop('o100_videoOps', SUBOP(SubOpsHE100.Common)),
        0x8D: makeop('o100_wait', SUBOP(SubOpsHE100.Wait, {
            SubOpsHE100.Wait.SO_WAIT_FOR_ACTOR: (OFFSET,),
        })),
        # TODO: 0x8e: makeop('o6_walkActorToObj'),
        0x8F: makeop('o6_walkActorTo'),
        0x89: makeop('o100_disabled_windowOps', SUBOP(SubOpsHE100.Common)),
        0x90: makeop('o100_writeFile', SUBOP(SubOpsHE100.Common, {
        ...
        0xB8: makeop('o100_getSpriteGroupInfo', SUBOP(SubOpsHE100.Common)),
        0xB9: makeop('o100_getHeap', SUBOP(SubOpsHE100.Heap)),
        0xBA: makeop('o100_getWizData', SUBOP(SubOpsHE100.Image)),
        ...
        0xC8: makeop('o100_getPaletteData', SUBOP(SubOpsHE100.Common)),
        ...
        0xD3: makeop('o100_readFile', SUBOP(SubOpsHE100.Common, {
            SubOpsHE100.Common.SO_ARRAY: (IMBYTE,),
        })),
        ...
        0xDB: makeop('o100_getSpriteInfo', SUBOP(SubOpsHE100.Common)),
        ...
        0xEC: makeop('o100_getVideoData', SUBOP(SubOpsHE100.Common)),
    }
)
